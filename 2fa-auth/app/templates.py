...
def get_2fa_ui_html(client_id: str, request: Request = None) -> HTMLResponse:
...
def get_2fa_verify_only_html(client_id: str, request: Request = None) -> HTMLResponse:
...
def get_success_html(request: Request = None) -> HTMLResponse:
...
def get_access_denied_html(request: Request = None) -> HTMLResponse:
