...
PostUp = iptables -I INPUT -i ${SERVER_WG_NIC} -p tcp --dport 443 -j ACCEPT
PostUp = iptables -I INPUT -i ${SERVER_WG_NIC} -p tcp --dport 80 -j ACCEPT
PostUp = iptables -I INPUT -i ${SERVER_PUB_NIC} -p tcp --dport 443 -j DROP
PostUp = iptables -I INPUT -i ${SERVER_PUB_NIC} -p tcp --dport 80 -j DROP
...
PostUp = iptables -I FORWARD -i ${SERVER_WG_NIC} -m set --match-set ws_2fa_allowed_v4 src -j ACCEPT
PostUp = iptables -A FORWARD -i ${SERVER_WG_NIC} -j WS_2FA_PORTAL
PostUp = iptables -t nat -A POSTROUTING -o ${SERVER_PUB_NIC} -j MASQUERADE
PostUp = ip6tables -I INPUT -i ${SERVER_WG_NIC} -p tcp --dport 443 -j ACCEPT
PostUp = ip6tables -I INPUT -i ${SERVER_WG_NIC} -p tcp --dport 80 -j ACCEPT
PostUp = ip6tables -I INPUT -i ${SERVER_PUB_NIC} -p tcp --dport 443 -j DROP
PostUp = ip6tables -I INPUT -i ${SERVER_PUB_NIC} -p tcp --dport 80 -j DROP
...
PostUp = ip6tables -I FORWARD -i ${SERVER_WG_NIC} -m set --match-set ws_2fa_allowed_v6 src -j ACCEPT
PostUp = ip6tables -A FORWARD -i ${SERVER_WG_NIC} -j WS_2FA_PORTAL6
PostUp = ip6tables -t nat -A POSTROUTING -o ${SERVER_PUB_NIC} -j MASQUERADE
PostDown = iptables -D INPUT -p udp --dport ${SERVER_PORT} -j ACCEPT
PostDown = iptables -D INPUT -i ${SERVER_WG_NIC} -p tcp --dport 443 -j ACCEPT 2>/dev/null || true
PostDown = iptables -D INPUT -i ${SERVER_WG_NIC} -p tcp --dport 80 -j ACCEPT 2>/dev/null || true
PostDown = iptables -D INPUT -i ${SERVER_PUB_NIC} -p tcp --dport 443 -j DROP 2>/dev/null || true
PostDown = iptables -D INPUT -i ${SERVER_PUB_NIC} -p tcp --dport 80 -j DROP 2>/dev/null || true
...
PostDown = ip6tables -D INPUT -i ${SERVER_WG_NIC} -p tcp --dport 80 -j ACCEPT 2>/dev/null || true
PostDown = ip6tables -D INPUT -i ${SERVER_PUB_NIC} -p tcp --dport 443 -j DROP 2>/dev/null || true
PostDown = ip6tables -D INPUT -i ${SERVER_PUB_NIC} -p tcp --dport 80 -j DROP 2>/dev/null || true
