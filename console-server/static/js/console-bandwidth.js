        ...
        const chartConfig = {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointBackgroundColor: WS_CHART_COLORS.blue,
                    pointBorderColor: '#fff',
                    pointBorderWidth: 2,
                    pointHoverBackgroundColor: '#fff',
                    pointHoverBorderColor: WS_CHART_COLORS.blue,
                    ...
                    pointRadius: chartType === 'line' ? (data.labels.length > 14 ? 0 : 4) : 0,
                    pointHoverRadius: chartType === 'line' ? 6 : 0,
                    pointBackgroundColor: WS_CHART_COLORS.green,
                    pointBorderColor: '#fff',
                    pointBorderWidth: 2,
                    pointHoverBackgroundColor: '#fff',
                    pointHoverBorderColor: WS_CHART_COLORS.green,
                    pointHoverBorderWidth: 3,
                    borderRadius: chartType === 'bar' ? 6 : 0
                }]
            },
